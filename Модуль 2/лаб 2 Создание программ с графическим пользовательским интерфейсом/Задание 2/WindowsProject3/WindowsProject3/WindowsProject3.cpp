...
INT CALLBACK WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR lpCmdLine, INT nCmdShow) {
    ...
    *HWND CreateWindowEx(12 параметров); */
    HWND hWnd;
    hWnd = CreateWindow(L"MyWindowClass"/* Имя класса окна*/, NULL/* Заголовок окна*/, WS_BORDER /*Стиль окна*/, 0, 0,/*Координаты левого верхнего угла*/300, 200,/*Размеры окна*/HWND_DESKTOP/*Дескриптор родительского окна*/, NULL/*Дескриптор главного меню*/, hInstance, NULL/*Указатель на массив дополнительных данных окна*/);
