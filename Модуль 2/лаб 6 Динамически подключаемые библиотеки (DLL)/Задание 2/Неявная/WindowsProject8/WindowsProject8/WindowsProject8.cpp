...
extern "C" __declspec(dllimport) wchar_t Name[];
extern "C" __declspec(dllimport) wstring getDecNumber(wstring str);
extern "C" __declspec(dllimport) wstring getBinNumber(int dec);
